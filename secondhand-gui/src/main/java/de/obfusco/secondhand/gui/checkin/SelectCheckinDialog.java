...
public class SelectCheckinDialog extends JDialog {
    ...
    public SelectCheckinDialog(ReservationRepository reservationRepository, ItemRepository itemRepository, StorageService storageService, TransactionListener transactionListener) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Bitte die Reservierung anklicken, für die Artikel eingecheckt werden sollen.");
    ...
    private static class TableCellRender extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focus, int row, int column) {
            ...
            int itemCount = Integer.parseInt(table.getValueAt(row, 2).toString());
            int checkedInCount = Integer.parseInt(table.getValueAt(row, 3).toString());
            Color fontColor = (itemCount == 0) ? Color.GRAY : Color.BLACK;
            Color backgroundColor = (itemCount > 0 && checkedInCount == itemCount) ? Color.GREEN : Color.WHITE;
